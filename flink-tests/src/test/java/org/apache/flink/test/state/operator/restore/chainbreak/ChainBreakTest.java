...
/**
 * Verifies that the state of an operator is restored if it was previously part of a chain
 */
public class ChainBreakTest extends AbstractOperatorRestoreTestBase {
