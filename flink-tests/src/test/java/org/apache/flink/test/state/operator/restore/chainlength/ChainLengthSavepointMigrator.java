...
public class ChainLengthSavepointMigrator {
	public static void main(String[] args) throws Exception {
		...
		URL savepointResource = AbstractOperatorRestoreTestBase.class.getClassLoader().getResource("operatorstate/chainLength/1.2");
