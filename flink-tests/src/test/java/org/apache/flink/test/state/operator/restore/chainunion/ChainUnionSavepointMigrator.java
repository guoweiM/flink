...
public class ChainUnionSavepointMigrator {
	public static void main(String[] args) throws Exception {
		...
		URL savepointResource = AbstractOperatorRestoreTestBase.class.getClassLoader().getResource("operatorstate/chainUnion/1.2");
