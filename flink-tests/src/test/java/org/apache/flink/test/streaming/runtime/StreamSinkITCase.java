	...
	public void streamingExecutionMode() throws Exception {
		...
		env.addSource(source, IntegerTypeInfo.INT_TYPE_INFO)
				.addSink(TestSink
						.newBuilder()
						.addWriter()
						.addCommitter((Supplier<Queue<String>> & Serializable) () -> STREAMING_COMMIT_QUEUE)
						.addGlobalCommitter((Supplier<Queue<String>> & Serializable) () -> STREAMING_GLOBAL_COMMIT_QUEUE)
						.build());
	...
	public void batchExecutionMode() throws Exception {
		...
		env.fromCollection(SOURCE_DATA)
				.addSink(TestSink
						.newBuilder()
						.addWriter()
						.addCommitter((Supplier<Queue<String>> & Serializable) () -> BATCH_COMMIT_QUEUE)
						.addGlobalCommitter((Supplier<Queue<String>> & Serializable) () -> BATCH_GLOBAL_COMMIT_QUEUE)
						.build());
		...
		assertThat(
				...
				containsInAnyOrder(expectedCommittedData.toArray()));
		System.err.println(BATCH_GLOBAL_COMMIT_QUEUE);
	}
}
