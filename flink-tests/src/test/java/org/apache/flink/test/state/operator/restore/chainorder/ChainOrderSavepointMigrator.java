...
public class ChainOrderSavepointMigrator {
	public static void main(String[] args) throws Exception {
		...
		URL savepointResource = AbstractOperatorRestoreTestBase.class.getClassLoader().getResource("operatorstate/chainOrder/1.2");
