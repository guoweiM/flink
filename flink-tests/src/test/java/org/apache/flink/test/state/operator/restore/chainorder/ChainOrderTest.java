 ...
 */
package org.apache.flink.test.state.operator.restore.chainorder;
...
/**
 * Verifies that the state of an operator is restored if it's position in the chain was changed
 */
public class ChainOrderTest extends AbstractOperatorRestoreTestBase {
	...
	protected void createOperators(DataStream<Integer> source) {
		...
		SingleOutputStreamOperator<Integer> positiveMap = Utils.createPositiveMap(negativeMap, true);
	}
