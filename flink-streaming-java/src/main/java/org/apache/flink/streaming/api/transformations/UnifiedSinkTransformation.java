...
public class UnifiedSinkTransformation<T> extends PhysicalTransformation<Object>{
	...
	private final UnifiedSinkOperatorFactory<T, ?> unifiedSinkOperatorFactory;
	...
	public UnifiedSinkTransformation(
		...
		String name,
		int parallelism,
		UnifiedSinkOperatorFactory<T, ?> unifiedSinkOperatorFactory) {
		super(name, TypeExtractor.getForClass(Object.class), parallelism);
		this.unifiedSinkOperatorFactory = unifiedSinkOperatorFactory;
		this.input = input;
	}
	...
	public StreamOperatorFactory<Object> getOperatorFactory() {
		return unifiedSinkOperatorFactory;
	}
	...
	public final void setChainingStrategy(ChainingStrategy strategy) {
		unifiedSinkOperatorFactory.setChainingStrategy(strategy);
	}
}
