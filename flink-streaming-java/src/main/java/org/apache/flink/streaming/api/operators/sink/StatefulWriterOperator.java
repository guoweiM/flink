...
final class StatefulWriterOperator<InputT, CommT, WriterStateT> extends AbstractWriterOperator<InputT, CommT> {
	...
	private transient ListState<WriterStateT> writerState;
	...
	public void snapshotState(StateSnapshotContext context) throws Exception {
		...
		writerState.update(getWriter().snapshotState());
	}

	@SuppressWarnings("unchecked")
	protected Writer<InputT, CommT, WriterStateT> getWriter() {
		return (Writer<InputT, CommT, WriterStateT>) super.getWriter();
	}
