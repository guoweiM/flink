 ...
 * TODO java doc.
 */
public class SplitSinkOperatorFactory<IN, SplitT> extends AbstractStreamOperatorFactory<SplitT> {

	private final SplitSink<IN, SplitT> splitSink;

	public SplitSinkOperatorFactory(SplitSink<IN, SplitT> splitSink) {
	...
	public <T extends StreamOperator<SplitT>> T createStreamOperator(StreamOperatorParameters<SplitT> parameters) {
		final SplitSinkOperator<IN, SplitT> splitSinkOperator = new SplitSinkOperator<>(splitSink);
	...
	public Class<? extends StreamOperator> getStreamOperatorClass(ClassLoader classLoader) {
		return SplitSinkOperator.class;
	}
}
