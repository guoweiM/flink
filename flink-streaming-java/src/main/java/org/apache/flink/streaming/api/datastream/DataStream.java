...
public class DataStream<T> {
	...
	public <SplitT> void addSink(Sink<T, SplitT> sink) {
		getExecutionEnvironment()
			.addOperator(
				new UnifiedSinkTransformation(
					this.transformation,
					"unified-sink",
					new UnifiedSinkOperatorFactory(sink),
					getExecutionEnvironment().getDefaultLocalParallelism()));
	}
